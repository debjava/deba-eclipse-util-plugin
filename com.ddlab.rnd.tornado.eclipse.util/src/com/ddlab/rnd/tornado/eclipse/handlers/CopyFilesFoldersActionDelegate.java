...
/**This is an ActionDelegate class for copy file/s and folder/s to clipboard.
 * @author <a href="mailto:debadatta.mishra@gmail.com"> Debadatta Mishra (PIKU)
 * @since 2013
 *
 */
public class CopyFilesFoldersActionDelegate implements IViewActionDelegate  {
	...
	public void run(IAction action) {
		/*
		 * For executing the copy functionality
		 */
		try {
	...
	/**
	 * Method to get the list of files path
	 * 
	 * @return
	 * @throws Exception
	 */
